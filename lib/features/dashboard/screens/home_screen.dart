                    ...
                    builder: (context, c) {
                      final cards = [
                        _ActionCard(
                          ...
                          onTap: () => Navigator.of(context).push(MaterialPageRoute(builder: (_) => const TeamListScreen())),
                        ),
                        _ActionCard(
                          icon: Icons.people_outline,
                          title: 'Players',
                          subtitle: 'Manage global players',
                          onTap: () => Navigator.of(context).push(MaterialPageRoute(builder: (_) => const PlayerListScreen())),
                        ),
                      ];
                      return c.maxWidth < 600
                          ? Column(children: [cards[0], const SizedBox(height: 16), cards[1]])
          ...
          child: Padding(
            ...
            child: Row(
              children: [
                ...
                Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [Text(title, style: Theme.of(context).textTheme.titleLarge), const SizedBox(height: 6), Text(subtitle)])),
...
class _EmptyState extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Card(
        child: SizedBox(
          ...
          child: Padding(
            padding: const EdgeInsets.all(24),
            child: Column(children: [Icon(icon, size: 32), const SizedBox(height: 8), Text(message)]),
          ),
        ),
      );
}
