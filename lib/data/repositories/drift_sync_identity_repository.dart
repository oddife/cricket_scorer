...
class DriftSyncIdentityRepository implements SyncIdentityRepository {
  ...
  @override
  Future<String> ensureInningsSyncId(int inningsId) => _ensure('innings', inningsId);
  @override
  Future<String> ensureBallEventSyncId(int ballEventId) => _ensure('ball', ballEventId);
  @override
  ...
  @override
  Future<String> ensureTeamPlayerSyncId(int teamPlayerId) => _ensure('team_player', teamPlayerId);
  @override
  Future<String> ensureTournamentSyncId(int tournamentId) => _ensure('tournament', tournamentId);
  ...
  @override
  Future<String?> getTeamPlayerSyncId(int teamPlayerId) => _get('team_player', teamPlayerId);
  @override
  Future<String?> getTournamentSyncId(int tournamentId) => _get('tournament', tournamentId);
  ...
  Future<String?> _get(String entityType, int localId) async {
    final rows = await _db.customSelect(
      '''SELECT sync_id FROM sync_entity_identities
